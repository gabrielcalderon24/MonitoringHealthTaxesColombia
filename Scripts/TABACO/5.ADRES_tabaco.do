...
// Guardamos base consolidada del recaudo, estos datos limpios nos permiten calcular el recaudo total para distintos rubros colapsando por año.
...
save "$carpetaMadre\Data\Created data\recaudoADRES_tabaco.dta", replace 
